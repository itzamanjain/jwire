...
const Contact = () => {
  return (
    <section className="body-font relative flex flex-col md:flex-row lg:mt-6 md:mb-12 bg-gray-100" id="contact">
      {/* Map Section */}
      <div className="md:flex-1 h-96 md:h-auto overflow-hidden">
        <iframe
          title="Google Maps"
      ...
      <div className="md:max-w-md w-full bg-white p-8 rounded shadow-md">
        <h2 className="text-3xl font-bold mb-6 text-gray-800">Contact Us</h2>

        <form action="#" method="POST" className="">
          <div className="mb-4">
            <label htmlFor="name" className="block text-gray-700 text-sm font-medium mb-2">Name</label>
            <input type="text" id="name" name="name" className="w-full border rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" />
          </div>
